...
![Profile icon — click to access your profile](assets/images/manage-profile/Accumpt1.png)
...
![Account settings page (1)](assets/images/manage-profile/2EN.png)
...
![Public profile page — tabs (3) and actions (4)](assets/images/manage-profile/3EN.png)
...
![Edit profile — editable fields (1)](assets/images/manage-profile/4EN.png)
...
![Open ORCID setting page](assets/images/manage-profile/Image01_Openorcidsettingpage.png)

![EPFL ORCID Integration Service button](assets/images/manage-profile/Image02_Authorizations.png)
...
![ORCID Integration at EPFL — Login button](assets/images/manage-profile/Image03_Orcidintegration.png)
...
![Register or Connect your ORCID iD](assets/images/manage-profile/Image04_IntegrationLinking.jpg)
...
![ORCID login page — Sign in to ORCID](assets/images/manage-profile/Image05_Signintorcid.png)
...
![ORCID Integration complete](assets/images/manage-profile/Image06_Integrated.png)
...
![Send ID button](assets/images/manage-profile/Image07_Sendit.png)

In addition, you will receive an email notification from ORCID that confirms the integration has been correctly performed.

![ORCID email notification confirming integration](assets/images/manage-profile/Image08_NotificationOrcidmail.png)
...
![ORCID identifier visible on Infoscience profile](assets/images/manage-profile/Image09_OrcidVisible.png)
...
![Open ORCID setting page — enable full features](assets/images/manage-profile/Image10_Openorcidsettingpage.png)

You will be redirected to the page shown below — then **click "Connect to ORCID iD"** to proceed.

![Connect to ORCID iD button](assets/images/manage-profile/Image11_ConnecttoOrcid.png)
...
![Green confirmation message — ORCID linked successfully](assets/images/manage-profile/Image12_GreenMessageGranted.png)
...
![Green ORCID icon on profile](assets/images/manage-profile/Image13_greeniconprofil.png)

and next to your publications, indicating a verified connection.

![Green ORCID icon on publications](assets/images/manage-profile/Image14_greeniconpublication.png)
...
![Disconnect from ORCID option](assets/images/manage-profile/Image15_Disconnect.png)
...
![Access ORCID Settings from profile page](assets/images/manage-profile/Image1AccessOrcidSettings.png)
...
![Synchronization mode selection — Manual or Batch](assets/images/manage-profile/Image2SyncMode.png)
...
![ORCID Registry Queue](assets/images/manage-profile/Image3OrcidQueue.png)
...
![ORCID email notification — Batch mode](assets/images/manage-profile/Image4OrcidmailNotification.png)
...
![Add icon in the ORCID Registry Queue](assets/images/manage-profile/image6.png)
...
![Queue actions — Add (red), Discard (blue), Update (yellow)](assets/images/manage-profile/Image6QueueActions.png)
...
![Queue rebuild — Disabled then All publications](assets/images/manage-profile/Image4QueueRebuilt.png)
