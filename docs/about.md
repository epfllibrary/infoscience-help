---
description: >-
  What is Infoscience? The EPFL institutional repository for scientific publications
  and research output: who can access it, roles, rights, content types, and how
  the platform is fed and maintained.
search:
  boost: 2.0
---
...
<figure markdown="span">
  ![age banner — About Infoscience](assets/images/about/banner.png){ width="300" }
</figure>
...
![Map of Infoscience users and their roles](https://www.epfl.ch/campus/library/wp-content/uploads/2024/07/Infoscience_users_map_EN-1024x576.png)
