...
A form is used to submit documents to Infoscience. This form allows you to describe the publication/resource being deposited, taking into account the specific characteristics of each type of document.

---

## Accessing the submission form

When making a deposit (see [Submit a publication](submit-a-publication.md)), start by selecting the relevant document family (**1**), then the appropriate document type (**2**).

You can choose between **3 main document families** (see [Document types](document-types.md) page):
...
![Document family selection (1)](assets/images/use-submission-form/1EN.png)
![Document type selection (2)](assets/images/use-submission-form/2EN.png)
...
![File import banner (1)](assets/images/use-submission-form/3EN.png)

After importing the file(s), you need to complete the metadata and access details by clicking on the Edit icon (**2**).

![Edit icon for file metadata (2)](assets/images/use-submission-form/4EN.png)

In the file form (**3**), certain fields are mandatory:

![File form with mandatory fields (3)](assets/images/use-submission-form/5EN.png)
...
![Unpaywall import tool (4)](assets/images/use-submission-form/6EN.png)
...
**To know more** about the file licenses, please refer to the EPFL Library Publishing Support **[Fastguides](https://infoscience.epfl.ch/handle/20.500.14299/173018)**.
...
Once the collection is chosen, a box opens up — choose the desired doctype. See the full information [page](document-types.md).
...
![Collection and document type selection (1)(2)(3)](assets/images/use-submission-form/7EN.png)
...
- (**1**) The DOI field is proposed by default, insert it in the "Identifiers" box. Infoscience retrieves metadata associated with the DOI from the [Crossref](https://www.crossref.org/) database to pre-fill the form (for example: authors, title, abstract, date, publisher metadata, and potentially the full text if it is available in Open Access via [Unpaywall](https://unpaywall.org/) import.

![DOI identifier field (1)](assets/images/use-submission-form/8EN.png)
...
![Other identifiers field (2)](assets/images/use-submission-form/9EN.png)
...
![Authors section with pop-up (1)](assets/images/use-submission-form/10EN.png)
...
![Journal references section](assets/images/use-submission-form/11EN.png)
...
![Other information section](assets/images/use-submission-form/13EN.png)
...
![Funding section — add funder (1)](assets/images/use-submission-form/14EN.png)

When you add a funder, a window opens (**2**): complete the field(s). Input help is available for funders (data from [RoR](https://ror.org/)) and grant names (data from [OpenAIRE](https://www.openaire.eu/)).

![Funder detail window (2)](assets/images/use-submission-form/15EN.png)
...
![Related works section](assets/images/use-submission-form/16EN.png)
...
![Related works — add relationship form](assets/images/use-submission-form/17EN.png)
...
![Potential duplicates detection](assets/images/use-submission-form/18.png)

It is up to you to analyse whether it is indeed a duplicate => to find out more about handling duplicates, please see the [Submit a publication](submit-a-publication.md#manage-duplicates) page.
...
![Books and Book Parts collection selection](assets/images/use-submission-form/19.png)
...
![Book reference fields](assets/images/use-submission-form/20EN.png)
...
Select the appropriate doctype (**1**) (please refer to the [page on Collection & DocType](document-types.md)).

![Conference document type selection (1)](assets/images/use-submission-form/21EN.png)

An additional section is added at the bottom of the form: "**Related Event, if applicable**" (**2**).

![Related Event section (2)](assets/images/use-submission-form/22EN.png)
...
![Related event detail form (3)](assets/images/use-submission-form/23EN.png)
...
![Dataset collection selection (1)](assets/images/use-submission-form/24EN.png)

**Basic Information** section (**2**):

- **Type**\*: choose the appropriate dataset subtype in the hierarchical tree (to find out more about subtypes and their definitions, consult the [Help page](document-types.md))
- **Identifiers**
- **Creator(s)**\*
- **Contributor(s)**
- **Title**\*
...
![Dataset basic information fields (2)](assets/images/use-submission-form/25EN.png)
...
![Item access conditions section (3)](assets/images/use-submission-form/16EN.png)

**Common files attributes** section (**4**):

- **Files global license**\*

![Common files attributes section (4)](assets/images/use-submission-form/27EN.png)
...
!!! note
    Don't forget to link your Dataset to the corresponding publication if available, in Infoscience or on an external database (see [Submit a publication](submit-a-publication.md#link-my-records-to-other-publications) — Relationship section).
...
![Patent collection selection (1)](assets/images/use-submission-form/28EN.png)
...
![Patent basic information — part 1 (2)](assets/images/use-submission-form/29EN.png)
...
![Patent basic information — part 2 (3)](assets/images/use-submission-form/30EN.png)
...
![Patent additional fields (4)](assets/images/use-submission-form/31EN.png)
