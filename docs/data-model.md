...
The interactive Metadata Application Profile lists all metadata fields for each public entity type (Publication, Product, Patent, OrgUnit, Person, Event, Journal) with their labels, constraints, authority control, type-binding rules, and Solr search indexes.

[View the Metadata Application Profile](metadata-profile.md){ .md-button .md-button--primary }
