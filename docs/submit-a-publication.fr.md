...
![Icône Nouveau dépôt (1) et accès au tableau de bord (2)](assets/images/submit-a-publication/Nouveau-depot1.png)

=> La page « Vos dépôts » s'affiche : cliquez sur « Nouveau dépôt » (**3**).

![Page Vos dépôts — bouton Nouveau dépôt (3)](assets/images/submit-a-publication/Nouveau-depot2.png)
...
![Import depuis une base externe — étapes (1)(2)(3)(4)(5)](assets/images/submit-a-publication/BaseExterne1.png)
...
![Import BibTeX — parcourir (1), notices brouillons (2), éditer (3)](assets/images/submit-a-publication/Bibtex.png)
...
![Créer une nouvelle version — menu (4)(5)](assets/images/submit-a-publication/Capture-decran-2024-10-18-122000.png)

**L'ancienne version sera archivée.** L'historique des versions est accessible depuis l'onglet « Versions » de la notice.

![Historique des versions dans l'onglet Versions](assets/images/submit-a-publication/Image1.png)
...
![Bouton Demander une correction (1)](assets/images/submit-a-publication/Image_ENG_49.png)
...
![Champ Related works dans le formulaire de dépôt (1)](assets/images/submit-a-publication/Relation.png)
...
![Détection de doublons — boutons (1)](assets/images/submit-a-publication/Doublons.png)
...
![Dépôt de dataset — collection Product (1)](assets/images/submit-a-publication/SetDeDonnees.png)
