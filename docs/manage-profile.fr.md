...
![Icône de profil — accès au compte et profil](assets/images/manage-profile/CompteEtProfil1.png)
...
![Page de paramétrage du compte (1)](assets/images/manage-profile/2FR.png)
...
![Profil public — onglets (3) et actions (4)](assets/images/manage-profile/3EN.png)
...
![Modifier le profil — champs modifiables (1)](assets/images/manage-profile/4EN.png)
...
<figure markdown="span">
  ...
  <figcaption>Vos publications, synchronisées et visibles partout</figcaption>
</figure>
...
![Ouvrir la page de paramétrage ORCID](assets/images/manage-profile/Image01_Openorcidsettingpage.png)

![Service d'intégration ORCID EPFL](assets/images/manage-profile/Image02_Authorizations.png)
...
![ORCID Integration at EPFL — bouton Login](assets/images/manage-profile/Image03_Orcidintegration.png)
...
![Enregistrer ou connecter votre ORCID iD](assets/images/manage-profile/Image04_IntegrationLinking.jpg)
...
![Page de connexion ORCID — Sign in to ORCID](assets/images/manage-profile/Image05_Signintorcid.png)
...
![Intégration ORCID complète](assets/images/manage-profile/Image06_Integrated.png)
...
![Bouton Send ID](assets/images/manage-profile/Image07_Sendit.png)

De plus, vous recevrez un e-mail de notification d'ORCID confirmant que l'intégration a été correctement effectuée.

![E-mail de notification ORCID confirmant l'intégration](assets/images/manage-profile/Image08_NotificationOrcidmail.png)
...
![Identifiant ORCID visible sur le profil Infoscience](assets/images/manage-profile/Image09_OrcidVisible.png)
...
![Ouvrir la page de paramétrage ORCID — activer toutes les fonctionnalités](assets/images/manage-profile/Image10_Openorcidsettingpage.png)

Vous serez redirigé·e vers la page ci-dessous — **cliquez sur « Connect to ORCID iD »** pour procéder.

![Bouton Connect to ORCID iD](assets/images/manage-profile/Image11_ConnecttoOrcid.png)
...
![Message de confirmation vert — ORCID lié avec succès](assets/images/manage-profile/Image12_GreenMessageGranted.png)

Une fois la procédure terminée, l'icône ORCID verte apparaîtra à côté de votre nom sur votre profil Infoscience

![Icône ORCID verte sur le profil](assets/images/manage-profile/Image13_greeniconprofil.png)

et à côté de vos publications, indiquant une connexion vérifiée.

![Icône ORCID verte sur les publications](assets/images/manage-profile/Image14_greeniconpublication.png)
...
![Option Disconnect from ORCID](assets/images/manage-profile/Image15_Disconnect.png)
...
![Accéder aux paramètres ORCID depuis la page de profil](assets/images/manage-profile/Image1AccessOrcidSettings.png)
...
![Sélection du mode de synchronisation — Manuel ou Par lot](assets/images/manage-profile/Image2SyncMode.png)
...
![File d'attente du registre ORCID](assets/images/manage-profile/Image3OrcidQueue.png)
...
![Notification e-mail ORCID — mode Par lot](assets/images/manage-profile/Image4OrcidmailNotification.png)
...
![Icône Ajouter dans la file d'attente ORCID](assets/images/manage-profile/image6.png)
...
![Actions de la file d'attente — Ajouter (rouge), Ignorer (bleu), Mettre à jour (jaune)](assets/images/manage-profile/Image6QueueActions.png)
...
![Reconstruire la file d'attente — Désactivé puis Toutes les publications](assets/images/manage-profile/Image4QueueRebuilt.png)
