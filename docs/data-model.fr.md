...
Le profil d'application des métadonnées interactif liste tous les champs de métadonnées pour chaque type d'entité public (Publication, Produit, Brevet, Unité, Personne, Événement, Revue), avec leurs labels, contraintes, contrôle d'autorité, règles de type-bind et index de recherche Solr.

[Voir le profil d'application des métadonnées](metadata-profile.fr.md){ .md-button .md-button--primary }
