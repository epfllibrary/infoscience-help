...
![Units EPFL icon on the Infoscience homepage](assets/images/manage-lab-unit/Manage_my_lab_unit_ENG_Image_01.png)

- Through the top bar menu under **Explore (1) > EPFL Units (2)**

![Explore menu — EPFL Units (1)(2)](assets/images/manage-lab-unit/Image_ENG_02-1.png)
...
![Unit search form](assets/images/manage-lab-unit/Image_ENG_03.png)

- **Selection from results:** once the search has been completed, click on the name of the unit to access its description page.

![Unit search results — click the unit name](assets/images/manage-lab-unit/Image_ENG_04.png)
...
![Unit page — scholarly works (1) and affiliated members (2)](assets/images/manage-lab-unit/Image_ENG_22-4.png)
...
![Unit page — action buttons](assets/images/manage-lab-unit/Image_ENG_23-1.png)
...
![Unit page — options menu (…)](assets/images/manage-lab-unit/Image_ENG_24.png)
...
![Edit option in the "…" menu (1)(2)](assets/images/manage-lab-unit/Image_ENG_25-2.png)
...
![Delegation of management field](assets/images/manage-lab-unit/Image_ENG_26.png)

- **Add an alias** (variant name of the unit).

![Alias field](assets/images/manage-lab-unit/Image_ENG_27_BIS.png)

- **Update unit foundation date**.

![Unit foundation date field](assets/images/manage-lab-unit/Image_ENG_28.png)

- **Add unit identifiers** based on the drop-down list options.

![Unit identifiers field](assets/images/manage-lab-unit/Image_ENG_29TERS.png)

- **Description** field to present your unit or give relevant information to be displayed.

![Description field](assets/images/manage-lab-unit/Image_ENG_30.png)

- **Unit type** to change the type of your unit (drop-down list options).

![Unit type drop-down](assets/images/manage-lab-unit/Image_ENG_31.png)

- **Custom URL** to replace the numerical URL provided by Infoscience. You may choose your lab acronym for example.

![Custom URL field](assets/images/manage-lab-unit/Image_ENG_32.png)

- **File upload** to add an image as a thumbnail.

![File upload section](assets/images/manage-lab-unit/Image_ENG_33.png)

Select the drop files bar at the top:

![Drop files bar](assets/images/manage-lab-unit/Image_ENG_34.png)

And drag or drop your file and then fill the file data (edit icon):

![Drag and drop file — fill file data](assets/images/manage-lab-unit/Image_ENG_35_BIS.png)

![File data edit form](assets/images/manage-lab-unit/Image_ENG_36.png)
...
![Log in with EPFL account button](assets/images/manage-lab-unit/Image_ENG_37.png)

**How to delegate management?**

- **From your unit page**, click on the "…" button, then select "**Edit**".

![Edit option — "…" button](assets/images/manage-lab-unit/Image_EGN_38.png)

- In the "**Delegated manager**" section, start entering the name of the person concerned and select him or her.

![Delegated manager field](assets/images/manage-lab-unit/Image_ENG_39.png)
...
![Subscribe button on the unit page](assets/images/manage-lab-unit/Image_ENG_40_BIS.png)

- **Select the frequency** of alerts (daily, weekly or monthly).

![Alert frequency selection](assets/images/manage-lab-unit/Image_ENG_41.png)

- **To modify or delete a subscription**, access your profile and click on "**Subscriptions**".

![Profile — Subscriptions menu](assets/images/manage-lab-unit/Image_ENG_42.png)

- **Adjust or deactivate notifications** according to your preferences.

![Subscriptions management page](assets/images/manage-lab-unit/Image_ENG_43_BIS.png)
...
![Edit Unit/Lab affiliations option](assets/images/manage-lab-unit/Image_ENG_44.png)
...
![Affiliation adjustment — remove or add unit](assets/images/manage-lab-unit/Image_ENG_45.png)
...
3. Select **"Create new version"**.
    ...
    ![Create new version option in the "…" menu](assets/images/manage-lab-unit/Image_ENG_46_TER.png)
...
![Versions tab showing version history](assets/images/manage-lab-unit/Image2-1.png)
...
3. Select "**Request a correction**".
    ...
    ![Request a correction option in the "…" menu](assets/images/manage-lab-unit/Image_ENG_49.png)

4. Modify or add the necessary fields in the form.
5. Replace attached files and update their metadata if necessary.

    ![Correction form — fields and files](assets/images/manage-lab-unit/Image_ENG_50.png)
...
1. **Retrieve your unit's URL** by copying it from your browser's address bar.
    ...
    ![Unit page URL in the browser address bar](assets/images/manage-lab-unit/Image_ENG_51.png)
...
3. **Add an "EPFL Infoscience" block** to an existing page or create a new one.
    ...
    ![WordPress — add EPFL Infoscience block](assets/images/manage-lab-unit/Capture-decran-2025-03-06-103142.png)

4. **Paste the copied URL** into the "A direct Infoscience URL" field.

    ![WordPress — A direct Infoscience URL field](assets/images/manage-lab-unit/Capture-decran-2025-03-06-103455.png)
...
5. **Adjust display parameters**. For ease of use, we advise you to:
    ...
    ![WordPress — display parameters](assets/images/manage-lab-unit/Capture-decran-2025-03-06-103622.png)
...
1. Click on "**Export**" in the record details.
    ...
    ![Export button in the record details](assets/images/manage-lab-unit/Image_ENG_52.png)

2. Select the desired format from the list.

    ![Export format selection](assets/images/manage-lab-unit/Image_ENG_56.png)
...
1. Perform a search (e.g. "positron") and click on "**Export**" from the results page.
    ...
    ![Export button on the results page](assets/images/manage-lab-unit/Image_ENG_53.png)
...
4. Decide whether you wish to **export all** the records in the search or a **manual selection**.
    ...
    ![Export options — all or manual selection](assets/images/manage-lab-unit/Image_ENG_54.png)

5. Click on "**Export**" and download the generated file once the operation is complete.

    ![Export download button](assets/images/manage-lab-unit/Image_ENG_55.png)
...
2. Click on the "**Save to Zotero**" icon in your browser.
    ...
    ![Save to Zotero icon in the browser](assets/images/manage-lab-unit/Image_ENG_57_BIS.png)
