...
![Sélection de la famille de documents (1)](assets/images/use-submission-form/1EN.png)
![Sélection du type de document (2)](assets/images/use-submission-form/2EN.png)
...
![Bannière d'import de fichiers (1)](assets/images/use-submission-form/3EN.png)
...
![Icône Éditer pour les métadonnées du fichier (2)](assets/images/use-submission-form/4EN.png)

Dans le formulaire fichier (**3**), certains champs sont obligatoires :

![Formulaire fichier avec champs obligatoires (3)](assets/images/use-submission-form/5EN.png)
...
![Outil Unpaywall (4)](assets/images/use-submission-form/6EN.png)
...
![Sélection de la collection et du type de document (1)(2)(3)](assets/images/use-submission-form/7EN.png)
...
![Champ DOI (1)](assets/images/use-submission-form/8EN.png)
...
![Autres identifiants (2)](assets/images/use-submission-form/9EN.png)
...
![Section Auteurs avec fenêtre contextuelle (1)](assets/images/use-submission-form/10EN.png)
...
![Section Références de revue](assets/images/use-submission-form/11EN.png)
...
![Section Autres informations](assets/images/use-submission-form/13EN.png)
...
![Section Financement — ajouter un financeur (1)](assets/images/use-submission-form/14EN.png)
...
![Fenêtre de détail du financeur (2)](assets/images/use-submission-form/15EN.png)
...
![Section Travaux liés](assets/images/use-submission-form/16EN.png)
...
![Formulaire d'ajout de relation](assets/images/use-submission-form/17EN.png)
...
![Détection de doublons potentiels](assets/images/use-submission-form/18.png)
...
![Sélection de la collection Livres et chapitres de livres](assets/images/use-submission-form/19.png)
...
![Champs de référence du livre](assets/images/use-submission-form/20EN.png)
...
![Sélection du type de document pour une conférence (1)](assets/images/use-submission-form/21EN.png)

Une section supplémentaire est ajoutée en bas du formulaire : « **Événement lié, si applicable** » (**2**).

![Section Événement lié (2)](assets/images/use-submission-form/22EN.png)
...
![Formulaire de détail de l'événement (3)](assets/images/use-submission-form/23EN.png)
...
![Sélection de la collection Dataset (1)](assets/images/use-submission-form/24EN.png)
...
![Champs d'informations de base du dataset (2)](assets/images/use-submission-form/25EN.png)

**Section Conditions d'accès** (**3**) : Type de condition d'accès (open access, embargo, accès restreint), Autoriser l'accès à partir de\*.

![Section conditions d'accès (3)](assets/images/use-submission-form/16EN.png)

**Section Attributs communs des fichiers** (**4**) : Licence globale des fichiers\*.

![Section attributs communs des fichiers (4)](assets/images/use-submission-form/27EN.png)
...
![Sélection de la collection Brevet (1)](assets/images/use-submission-form/28EN.png)
...
![Informations de base du brevet — partie 1 (2)](assets/images/use-submission-form/29EN.png)

(**3**) : ID de famille, Titre\*, Titres supplémentaires, Inventeur(s)\*, Déposant(s), Résumé.

![Informations de base du brevet — partie 2 (3)](assets/images/use-submission-form/30EN.png)

(**4**) : **Classification TTO**, **Mots-clés**, **Unités EPFL impliquées**\*, **Écrit pendant une affiliation avec l'EPFL**\*.

![Champs supplémentaires du brevet (4)](assets/images/use-submission-form/31EN.png)
