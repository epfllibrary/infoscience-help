...
![Bannière — Rechercher et consulter](assets/images/search-and-consult/banner.png)
...
![Barre de recherche Infoscience](assets/images/search-and-consult/BarreDeRecherche.png)
...
![Filtres et facettes sur la page de résultats](assets/images/search-and-consult/AffichezFiltres.png)
...
![Menus de navigation Infoscience](assets/images/search-and-consult/Menus.png)
...
![Menu Explorer — recherche avancée (1)](assets/images/search-and-consult/MenuExplorer1.png)

Les **index disponibles** pour la recherche sont proposés dans le menu déroulant (**2**).

![Menu Explorer — index disponibles (2)](assets/images/search-and-consult/MenuExplorer2-1.png)
...
![Notice brève (1)](assets/images/search-and-consult/NoticeBreve1.png)
...
![Notice détaillée — boutons d'action (2)](assets/images/search-and-consult/Capture-decran-2024-08-28-111203.png)
...
![Notice détaillée — onglet Files (3)](assets/images/search-and-consult/NoticeDetaillee3.png)
...
![Notice détaillée — onglet Details (4)](assets/images/search-and-consult/Capture-decran-2024-08-28-111828.png)
...
![Notice détaillée — onglet Metrics (5)](assets/images/search-and-consult/NoticeDetaillee5.png)
...
![Options d'accès aux fichiers](assets/images/search-and-consult/AccederAuxFichiers.png)
...
![Bouton S'abonner et paramètres de notification (1)(2)](assets/images/search-and-consult/Alertes.png)
...
![Icône de profil — menu Abonnements (1)](assets/images/search-and-consult/Alertes3.png)
...
![Page de gestion des abonnements (2)](assets/images/search-and-consult/Alertes2.png)
...
![Statistiques du site (1)](assets/images/search-and-consult/StatistiquesSite.png)
...
![Statistiques d'une notice (1)(2)(3)](assets/images/search-and-consult/StatistiquesNotice.png)
